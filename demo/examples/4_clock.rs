...
// 高星答案
// 2023/8/17: 这里将一天看成1440分钟来做的，有以下几点。
// 1. 每天都是0-1440分钟，也就是24小时，所以(分钟数%day)一定小于day，如果还小于0，那就是昨天，大于0就是今天。
// 2. 不过昨天今天，+day，就可能是今天明天，然后%day，那么就一定是今天。输出的时候再区分hour and minutes。
